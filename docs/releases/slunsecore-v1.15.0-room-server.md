# SlunseCore Room Server Firmware v1.15.0

SlunseCore room server builds are based on **MeshCore v1.15.0** with some extra features and tweaks.

**Upstream release:** [MeshCore v1.15.0 — 19 Apr 2026](https://blog.meshcore.io/2026/04/19/release-1-15-0)

## SlunseCore changes

- **SenseCap Solar:** Fixed remapped LEDs (LoRa TX = blue); PWR and USR buttons enabled for use.
- **GPS saver (room servers with GPS):** Extra CLI commands to configure GPS power-save behaviour on room servers (see `docs/cli_commands.md` on this branch).
